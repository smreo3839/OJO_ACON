				...
				<div class="row">
					<div class="col-md-12 col-lg-8">
						<div class="title-single-box">
							<h1 class="title-single">내가작성한글</h1>
							<span class="color-text-a">커뮤니티에 내가 작성한글을 확인할 수 있습니다.</span>
						</div>
					</div>
				...
				<table class="table table-hover">
					...
					<tbody>
						...
						<tr class="row-subject">
							...
							<td>${li2.rcode}</td>
							<td>${li2.cate}</td>
							<td><a href="${pageContext.request.contextPath}/group/view?gcode=${li2.gcode}">${li2.title}</a></td>
							<td>${li2.cnt}</td>
							<td>${li2.ucode}</td>
							<td>${li2.regdate}</td>
						</tr>
